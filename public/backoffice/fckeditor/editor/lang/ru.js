...
DlgDTnolorsTab		: "Цвета и отступы",
...
DlgDTnharSet		: "Кодировка набора символов",
DlgDTnharSetCE		: "Центрально-европейская",
DlgDTnharSetCT		: "Китайская традиционная (Big5)",
DlgDTnharSetCR		: "Кириллица",
DlgDTnharSetGR		: "Греческая",
DlgDTnharSetJP		: "Японская",
DlgDTnharSetKR		: "Корейская",
DlgDTnharSetTR		: "Турецкая",
DlgDTnharSetUN		: "Юникод (UTF-8)",
DlgDTnharSetWE		: "Западно-европейская",
DlgDTnharSetOther	: "Другая кодировка набора символов",
...
DlgDTnText			: "Текст",
DlgDTnLink			: "Ссылка",
DlgDTnVisited		: "Посещенная ссылка",
DlgDTnActive		: "Активная ссылка",
