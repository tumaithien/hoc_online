...
DlgDTnolorsTab		: "Кольори та відступи",
...
DlgDTnharSet		: "Кодування набору символів",
DlgDTnharSetCE		: "Центрально-європейська",
DlgDTnharSetCT		: "Китайська традиційна (Big5)",
DlgDTnharSetCR		: "Кирилиця",
DlgDTnharSetGR		: "Грецька",
DlgDTnharSetJP		: "Японська",
DlgDTnharSetKR		: "Корейська",
DlgDTnharSetTR		: "Турецька",
DlgDTnharSetUN		: "Юнікод (UTF-8)",
DlgDTnharSetWE		: "Західно-европейская",
DlgDTnharSetOther	: "Інше кодування набору символів",
...
DlgDTnText			: "Текст",
DlgDTnLink			: "Посилання",
DlgDTnVisited		: "Відвідане посилання",
DlgDTnActive		: "Активне посилання",
