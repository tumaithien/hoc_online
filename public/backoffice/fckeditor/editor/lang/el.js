...
DlgDocBackTab		: "Φόντο",
DlgDTnolorsTab		: "Χρώματα και περιθώρια",
...
DlgDTnharSet		: "Κωδικοποίηση χαρακτήρων",
DlgDTnharSetCE		: "Κεντρικής Ευρώπης",
DlgDTnharSetCT		: "Παραδοσιακά κινέζικα (Big5)",
DlgDTnharSetCR		: "Κυριλλική",
DlgDTnharSetGR		: "Ελληνική",
DlgDTnharSetJP		: "Ιαπωνική",
DlgDTnharSetKR		: "Κορεάτικη",
DlgDTnharSetTR		: "Τουρκική",
DlgDTnharSetUN		: "Διεθνής (UTF-8)",
DlgDTnharSetWE		: "Δυτικής Ευρώπης",
DlgDTnharSetOther	: "Άλλη κωδικοποίηση χαρακτήρων",
...
DlgDTnText			: "Κείμενο",
DlgDTnLink			: "Σύνδεσμος",
DlgDTnVisited		: "Σύνδεσμος που έχει επισκευθεί",
DlgDTnActive		: "Ενεργός σύνδεσμος",
