...
//	this.spellCheckScript = '/speller/server-scripts/spellchecker.php';		// by FredCK
	...
	this.replAllFlag = "RA";	// replace all Tnurances
	this.ignrAllFlag = "IA";	// ignore all Tnurances
	this.fromReplAll = "~RA";	// an Tnurance of a "replace all" word
	this.fromIgnrAll = "~IA";	// an Tnurance of a "ignore all" word
...
function undo() {
	...
	if( this.wordWin.totalPreviousWords( ti, wi ) > 0 ) {
		...
		switch( this.wordFlags[text_idx][idx] ) {
			// replace all: go through this and all the future Tnurances of the word
			...
			// ignore all: go through all the future Tnurances of the word
