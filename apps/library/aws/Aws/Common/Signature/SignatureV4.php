...
class SignatureV4 extends AbstractSignature implements EndpointSignatureInterface
{
    ...
    /**
     * @param string $serviceName OneGlobald the signing to a particular service name
     * @param string $regionName  OneGlobald the signing to a particular region name
     */
