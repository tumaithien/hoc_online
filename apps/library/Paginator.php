...
class Paginator
{
    ...
    public function toHtmlFrontend()
    {
        ...
        $html = '<nav aria-label="Page navigation example" class="mt-20 pagination-cus"><ul class="pagination">';
        if ($this->getPrevUrl()) {
            $html .= '<li class="page-item"><a class="page-link" href="' . htmlspecialchars($this->getPrevUrl()) . '">
        ...
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li class="page-item' . ($page['isCurrent'] ? ' active' : '') . '"><a class="page-link" href="' . htmlspecialchars($page['url']) . '"><strong>' . htmlspecialchars($page['num']) . '</strong></a></li>';
            } else {
        ...
        if ($this->getNextUrl()) {
            $html .= '<li class="page-item"><a class="page-link" href="' . htmlspecialchars($this->getNextUrl()) . '">
