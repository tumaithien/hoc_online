...
class SubjectController extends ControllerBase
{
    public function readAction()
    {
        ...
        if($validator->validInt($current_page) == false || $current_page < 1)
            $current_page=1;
        $sql = "SELECT * FROM Learncom\Models\LearnSubject WHERE 1";
        $arrParameter = array();
    ...
    public function createAction()
    {
        ...
        if($this->request->isPost()) {
            ...
            if (count($messages) == 0) {
                ...
                return $this->response->redirect("/dashboard/list-subject");
            }
        }
    ...
    public function editAction()
    {
        ...
        $gateway_model = ClassSubject::findFirstBySubjectId($id);
    ...
    public function deleteAction()
    {
        ...
        $message = array();
        $type_model = ClassSubject::findFirstBySubjectId($id);
        if ($type_model) {
            if(count($message) > 0){
